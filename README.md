...
If you're interested in going deeper, I highly recommend checking out my work on the Vortex GPGPU's [Tensor Core Unit (TCU) extension's DRL Floating Point RTL backend](https://github.com/vortexgpgpu/vortex/tree/bug_fixes/hw/rtl/tcu) for a significantly more [researched](https://arxiv.org/abs/2512.00053), optimized and realistic microarchitecture implementation.
